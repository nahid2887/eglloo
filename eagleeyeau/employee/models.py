...
class TimeEntry(models.Model):
    """Model for employee time entries - Only for Employee role users"""
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='employee_time_entries')
    ...
    class Meta:
        ...
        verbose_name = 'Employee Time Entry'
        verbose_name_plural = 'Employee Time Entries'
